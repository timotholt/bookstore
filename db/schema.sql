...
('b001', 'the-night-circus', 'The Night Circus', (SELECT id FROM authors WHERE slug='erin-morgenstern'), (SELECT id FROM genres WHERE slug='fiction'), 2012, '9780307744432', '2012-01-01', '#1a2e26', 0.65, 'magical,atmospheric,romance', 'The Night Circus Erin Morgenstern Fiction magical atmospheric romance', 0),
('b002', 'kitchen-confidential', 'Kitchen Confidential', (SELECT id FROM authors WHERE slug='anthony-bourdain'), (SELECT id FROM genres WHERE slug='memoir'), 2007, '9780060899226', '2007-01-01', '#6b1827', 0.72, 'food,memoir,sharp', 'Kitchen Confidential Anthony Bourdain Memoir food memoir sharp', 1),
('b003', 'dune', 'Dune', (SELECT id FROM authors WHERE slug='frank-herbert'), (SELECT id FROM genres WHERE slug='science-fiction'), 2019, '9780441172719', '2019-01-01', '#a7482f', 0.68, 'classic,desert,politics', 'Dune Frank Herbert Science Fiction scifi sci-fi classic desert politics', 1),
('b004', 'the-secret-history', 'The Secret History', (SELECT id FROM authors WHERE slug='donna-tartt'), (SELECT id FROM genres WHERE slug='mystery'), 2004, '9781400031702', '2004-01-01', '#233e54', 0.75, 'campus,literary,dark', 'The Secret History Donna Tartt Mystery campus literary dark', 0),
('b005', 'braiding-sweetgrass', 'Braiding Sweetgrass', (SELECT id FROM authors WHERE slug='robin-wall-kimmerer'), (SELECT id FROM genres WHERE slug='nature'), 2020, '9781571313560', '2020-01-01', '#284234', 0.70, 'ecology,essays,indigenous', 'Braiding Sweetgrass Robin Wall Kimmerer Nature ecology essays indigenous', 0),
('b006', 'the-thursday-murder-club', 'The Thursday Murder Club', (SELECT id FROM authors WHERE slug='richard-osman'), (SELECT id FROM genres WHERE slug='mystery'), 2021, '9781984880987', '2021-01-01', '#b48c34', 0.62, 'cozy,witty,series', 'The Thursday Murder Club Richard Osman Mystery cozy witty series', 1),
('b007', 'a-gentleman-in-moscow', 'A Gentleman in Moscow', (SELECT id FROM authors WHERE slug='amor-towles'), (SELECT id FROM genres WHERE slug='historical-fiction'), 2019, '9780143110439', '2019-01-01', '#263e52', 0.74, 'elegant,hotel,historical', 'A Gentleman in Moscow Amor Towles Historical Fiction elegant hotel historical', 0),
('b008', 'the-hobbit', 'The Hobbit', (SELECT id FROM authors WHERE slug='j-r-r-tolkien'), (SELECT id FROM genres WHERE slug='fantasy'), 2001, '9780618260300', '2001-01-01', '#4e5933', 0.60, 'classic,adventure,quest', 'The Hobbit J.R.R. Tolkien Fantasy classic adventure quest', 0),
('b009', 'salt-fat-acid-heat', 'Salt Fat Acid Heat', (SELECT id FROM authors WHERE slug='samin-nosrat'), (SELECT id FROM genres WHERE slug='cookbooks'), 2017, '9781476753836', '2017-01-01', '#ab5433', 0.82, 'cooking,illustrated,technique', 'Salt Fat Acid Heat Samin Nosrat Cookbooks cooking illustrated technique', 1),
('b010', 'the-warmth-of-other-suns', 'The Warmth of Other Suns', (SELECT id FROM authors WHERE slug='isabel-wilkerson'), (SELECT id FROM genres WHERE slug='history'), 2011, '9780679763888', '2011-01-01', '#543928', 0.71, 'history,migration,america', 'The Warmth of Other Suns Isabel Wilkerson History migration america', 0),
('b011', 'project-hail-mary', 'Project Hail Mary', (SELECT id FROM authors WHERE slug='andy-weir'), (SELECT id FROM genres WHERE slug='science-fiction'), 2022, '9780593135228', '2022-01-01', '#214e63', 0.66, 'space,clever,survival', 'Project Hail Mary Andy Weir Science Fiction scifi sci-fi space clever survival', 1),
('b012', 'the-vanishing-half', 'The Vanishing Half', (SELECT id FROM authors WHERE slug='brit-bennett'), (SELECT id FROM genres WHERE slug='fiction'), 2021, '9780525536963', '2021-01-01', '#73334c', 0.73, 'family,identity,literary', 'The Vanishing Half Brit Bennett Fiction family identity literary', 0),
('b013', 'world-of-wonders', 'World of Wonders', (SELECT id FROM authors WHERE slug='aimee-nezhukumatathil'), (SELECT id FROM genres WHERE slug='nature'), 2020, '9781571313652', '2020-01-01', '#2b5c5a', 0.78, 'essays,nature,lyrical', 'World of Wonders Aimee Nezhukumatathil Nature essays lyrical', 0),
('b014', 'the-book-thief', 'The Book Thief', (SELECT id FROM authors WHERE slug='markus-zusak'), (SELECT id FROM genres WHERE slug='historical-fiction'), 2007, '9780375842207', '2007-01-01', '#3f4b54', 0.63, 'historical,young adult,moving', 'The Book Thief Markus Zusak Historical Fiction young adult moving', 0),
('b015', 'the-midnight-library', 'The Midnight Library', (SELECT id FROM authors WHERE slug='matt-haig'), (SELECT id FROM genres WHERE slug='fiction'), 2020, '9780525559474', '2020-01-01', '#204663', 0.77, 'reflective,second chances,bookish', 'The Midnight Library Matt Haig Fiction reflective second chances bookish', 1),
('b016', 'the-overstory', 'The Overstory', (SELECT id FROM authors WHERE slug='richard-powers'), (SELECT id FROM genres WHERE slug='fiction'), 2019, '9780393356687', '2019-01-01', '#2b522b', 0.69, 'trees,pulitzer,ambitious', 'The Overstory Richard Powers Fiction trees pulitzer ambitious', 0),
('b017', 'educated', 'Educated', (SELECT id FROM authors WHERE slug='tara-westover'), (SELECT id FROM genres WHERE slug='memoir'), 2020, '9780399590528', '2020-01-01', '#5c3d2e', 0.64, 'memoir,resilience,family', 'Educated Tara Westover Memoir resilience family', 0),
('b018', 'the-art-forger', 'The Art Forger', (SELECT id FROM authors WHERE slug='b-a-shapiro'), (SELECT id FROM genres WHERE slug='mystery'), 2013, '9781616203160', '2013-01-01', '#523b6b', 0.73, 'art,heist,boston', 'The Art Forger B.A. Shapiro Mystery art heist boston', 0),
('b019', 'pachinko', 'Pachinko', (SELECT id FROM authors WHERE slug='min-jin-lee'), (SELECT id FROM genres WHERE slug='historical-fiction'), 2017, '9781455563920', '2017-01-01', '#7d2b24', 0.67, 'family saga,korea,japan', 'Pachinko Min Jin Lee Historical Fiction family saga korea japan', 1),
('b020', 'the-splendid-and-the-vile', 'The Splendid and the Vile', (SELECT id FROM authors WHERE slug='erik-larson'), (SELECT id FROM genres WHERE slug='history'), 2020, '9780385348713', '2020-01-01', '#182d42', 0.79, 'churchill,wwii,narrative', 'The Splendid and the Vile Erik Larson History churchill wwii narrative', 0),
('b021', 'circe', 'Circe', (SELECT id FROM authors WHERE slug='madeline-miller'), (SELECT id FROM genres WHERE slug='fantasy'), 2019, '9780316556323', '2019-01-01', '#8c4f1c', 0.66, 'mythology,greek,literary', 'Circe Madeline Miller Fantasy mythology greek literary', 0),
('b022', 'the-body-keeps-the-score', 'The Body Keeps the Score', (SELECT id FROM authors WHERE slug='bessel-van-der-kolk'), (SELECT id FROM genres WHERE slug='psychology'), 2015, '9780143127741', '2015-01-01', '#2d444f', 0.72, 'psychology,trauma,health', 'The Body Keeps the Score Bessel van der Kolk Psychology trauma health', 0),
('b023', 'the-joy-of-cooking', 'The Joy of Cooking', (SELECT id FROM authors WHERE slug='irma-s-rombauer'), (SELECT id FROM genres WHERE slug='cookbooks'), 2006, '9780743246262', '2006-01-01', '#6b401d', 0.84, 'classic,reference,cooking', 'The Joy of Cooking Irma S. Rombauer Cookbooks classic reference cooking', 0),
('b024', 'the-house-in-the-cerulean-sea', 'The House in the Cerulean Sea', (SELECT id FROM authors WHERE slug='tj-klune'), (SELECT id FROM genres WHERE slug='fantasy'), 2021, '9781250217318', '2021-01-01', '#235c70', 0.69, 'warm,found family,hopeful', 'The House in the Cerulean Sea TJ Klune Fantasy warm found family hopeful', 1),
('b025', 'say-nothing', 'Say Nothing', (SELECT id FROM authors WHERE slug='patrick-radden-keefe'), (SELECT id FROM genres WHERE slug='history'), 2020, '9780307279286', '2020-01-01', '#323528', 0.70, 'ireland,true crime,politics', 'Say Nothing Patrick Radden Keefe History ireland true crime politics', 0),
('b026', 'the-invisible-life-of-addie-larue', 'The Invisible Life of Addie LaRue', (SELECT id FROM authors WHERE slug='v-e-schwab'), (SELECT id FROM genres WHERE slug='fantasy'), 2020, '9780765387561', '2020-01-01', '#13273b', 0.78, 'immortality,romance,paris', 'The Invisible Life of Addie LaRue V.E. Schwab Fantasy immortality romance paris', 1),
('b027', 'atomic-habits', 'Atomic Habits', (SELECT id FROM authors WHERE slug='james-clear'), (SELECT id FROM genres WHERE slug='business'), 2018, '9780735211292', '2018-01-01', '#162329', 0.65, 'habits,productivity,practical', 'Atomic Habits James Clear Business habits productivity practical', 0),
('b028', 'the-feather-thief', 'The Feather Thief', (SELECT id FROM authors WHERE slug='kirk-wallace-johnson'), (SELECT id FROM genres WHERE slug='mystery'), 2019, '9781101981634', '2019-01-01', '#2e4a46', 0.71, 'true crime,natural history,odd', 'The Feather Thief Kirk Wallace Johnson Mystery true crime natural history odd', 0);
